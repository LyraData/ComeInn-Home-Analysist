...
def load_and_preprocess(path):
    ...
    # Danh sách các cột phân loại cần encode
    ...
    # Các đặc trưng sử dụng để huấn luyện (loại bỏ TempResidenceStatus nếu có)
    features = [
...
if __name__ == "__main__":
    data_path = r"D:\COMEINN_HOME_PROJECT\FLASKAPI\customer_behavior.csv"
